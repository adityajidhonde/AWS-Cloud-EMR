...
// Set log level
        ...
        // Paths to datasets
        String inputPath = "s3://adityastores/TrainingDataset.csv";  // Replace with your file path
        String validPath = "s3://adityastores/ValidationDataset.csv";  // Replace with your file path
...
// Evaluate model
            ...
            // Save the model
            String modelPath = "s3://adityastores/" + classifier.getClass().getSimpleName();
            try {
